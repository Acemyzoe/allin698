...
static struct Nuitka_MetaPathBasedLoaderEntry meta_path_loader_entries[] = {
    ...
    {"common", modulecode_common, 0, 0, NUITKA_TRANSLATED_FLAG},
    ...
    {"ctypes.macholib.dyld", NULL, 77, 4377, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    ...
    {"ctypes.util", NULL, 80, 8362, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    ...
    {"distutils.cygwinccompiler", NULL, 120, 8608, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    ...
    {"distutils.sysconfig", NULL, 134, 12071, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    {"distutils.text_file", NULL, 135, 8392, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    {"distutils.unixccompiler", NULL, 136, 6554, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    ...
    {"ftplib", NULL, 302, 28172, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    ...
    {"http.client", NULL, 317, 35551, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    ...
    {"ipaddress", NULL, 333, 62764, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    ...
    {"platform", NULL, 460, 28147, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    {"plistlib", NULL, 461, 25496, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    ...
    {"pydoc", NULL, 469, 83616, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    {"pydoc_data", NULL, 470, 84, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG},
    {"pydoc_data.topics", NULL, 471, 415045, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    ...
    {"re", NULL, 475, 13865, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    ...
    {"shlex", NULL, 483, 7132, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    ...
    {"smtplib", NULL, 488, 35299, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    {"sndhdr", NULL, 489, 6850, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    {"socket", NULL, 490, 21984, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    {"socketserver", NULL, 491, 24147, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    ...
    {"stat", NULL, 499, 4291, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    ...
    {"subprocess", NULL, 504, 39161, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    ...
    {"symtable", NULL, 507, 10401, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    {"sysconfig", NULL, 508, 15610, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    {"tabnanny", NULL, 509, 6925, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    {"tarfile", NULL, 510, 61847, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    {"telnetlib", NULL, 511, 18049, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    {"tempfile", NULL, 512, 22175, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    ...
    {"threading", NULL, 515, 37880, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    {"timeit", NULL, 516, 11632, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    {"tkinter", NULL, 517, 179116, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG},
    ...
    {"tkinter.tix", NULL, 528, 83615, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    {"tkinter.ttk", NULL, 529, 57839, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    ...
    {"trace", NULL, 532, 19267, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    {"traceback", NULL, 533, 19569, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    ...
    {"typing", NULL, 537, 50976, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    ...
    {"unittest.case", NULL, 539, 48318, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    ...
    {"unittest.mock", NULL, 542, 64893, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    ...
    {"urllib.parse", NULL, 550, 31322, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    {"urllib.request", NULL, 551, 72427, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    ...
    {"uu", NULL, 554, 3572, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    {"uuid", NULL, 555, 23150, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    {"venv", NULL, 556, 14480, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG | NUITKA_PACKAGE_FLAG},
    {"warnings", NULL, 557, 13783, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    {"wave", NULL, 558, 18236, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    {"weakref", NULL, 559, 19516, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    {"webbrowser", NULL, 560, 16896, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    ...
    {"zipfile", NULL, 594, 50279, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    {"__future__", NULL, 0, 4079, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    {"_bootlocale", NULL, 1, 1196, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    {"_collections_abc", NULL, 2, 28889, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
    {"_compat_pickle", NULL, 3, 5755, NUITKA_TRANSLATED_FLAG | NUITKA_BYTECODE_FLAG},
